...
TEST_HDFS_FILENAMES = ["static_babynames1", "static_babynames2", "static_babynames2"]
...
class TestMultipleFilesWebHdfsSensor:
    ...
    def test_poke_should_return_false_for_missing_file(self, mock_hook):
        mock_hook.return_value.get_conn.return_value.list.return_value = TEST_HDFS_FILENAMES[:-1]
